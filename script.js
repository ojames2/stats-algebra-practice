...
// ✅ Replace the duplicate lines with this:
  const quizBtn = document.getElementById("comprehensive-quiz-btn");
  if (quizBtn) {
    quizBtn.addEventListener("click", launchComprehensiveQuiz);
  }
